...
class Employee(Person):
    company="Acme Corp"; bonus_pct=5
    def __init__(self,name,age,emp_id,salary):
        super().__init__(name,age)
        self.emp_id=emp_id; self.salary=salary
    def work_intro(self):
...
class Manager(Employee):
    ...
    def team_total_salary(self):
        total=self.salary
        for e in self.team: total+=e.salary
        return total
...
e1=Employee("Alice",25,"E001",100000)
e2=Employee("Bob",30,"E002",80000)
print(e1.greet()); print(e1.work_intro())
print(e2.greet()); print(e2.work_intro())

m=Manager("Carol",40,"M001",150000,[])
m.add_member(e1); m.add_member(e2)
print(m.greet()); print(m.work_intro()); print(m.team_intro())

e1.apply_bonus(); e2.apply_bonus(); m.apply_bonus()
Employee.set_bonus(10); m.apply_bonus()
